...
<div class="content-block content-width overflow-auto text-align-justify">
    <div class="margin-bottom-40 overflow-auto">
        <div class="c22 grid-columns">
            ...
            <p>Thank you for choosing the <strong>PHP MVC Framework</strong>. This is a simple and easy to use framework that will help you build your web applications faster and more efficiently.</p>
